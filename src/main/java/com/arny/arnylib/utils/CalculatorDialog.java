...
public class CalculatorDialog extends ADBuilder {
	...
	private StringBuilder mDisplay;
	...
	private void updateMainDisplay() {
		mTvDisplay.setText(mDisplay.toString());
	}
	...
	private String cut(String input) {
		String out = input;
		Log.d(CalculatorDialog.class.getSimpleName(), "cut: out:" + out);
		...
		Log.d(CalculatorDialog.class.getSimpleName(), "cut: res:" + out);
		return out;
	}
	...
	private void processActionKey(ActionKey k) {
		switch (k) {
			case CLEAR:
				...
				break;
			case DEL:
				mCalculator.setInput(cut(mDisplay.toString()));
				mCalculator.handleKeyPress(Calculator.Key.DEL);
