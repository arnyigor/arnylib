...
public class CalcDialog extends DialogFragment {
    ...
    private CalcDialogResultListener dialogResultListener;

    interface CalcDialogResultListener {
        void onResult(BigDecimal result);
    }

    public CalcDialog setResultListener(CalcDialogResultListener dialogResultListener) {
     ...
     */
    public CalcDialog() {
        maxValue = new BigDecimal("1.7976931348623157E308");
        maxIntDigits = 10;
        maxFracDigits = 23;
    ...
    @Override
    public @NonNull
    Dialog onCreateDialog(Bundle state) {
        LayoutInflater inflater = LayoutInflater.from(context);
        @SuppressLint("InflateParams") final View view = inflater.inflate(R.layout.dialog_calc, null);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            operatorBtn.setOnClickListener(v -> {
                if (dismissError()) return;
        ...
        okBtn.setOnClickListener(v -> {
            ...
            if (error == ERROR_NONE) {
                ...
                if (dialogResultListener != null) {
                    dialogResultListener.onResult(resultValue);
                }
                dismiss();
            }
        });
        ...
        dialog.setOnShowListener(dialogInterface -> {
            ...
            if (dialogWindow != null) {
                dialogWindow.getDecorView().getBackground().getPadding(fgPadding);
            }
